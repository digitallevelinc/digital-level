            ...
            <div class="group/item border-b border-white/[0.03] py-4 last:border-0 px-2 hover:bg-white/[0.01] transition-colors">
                <div class="flex justify-between items-start mb-3">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-[12px] text-white-600 uppercase font-black mt-1 italic tracking-wide">Profit</p>
                    </div>
                </div>
                ...
                <div class="space-y-1.5 px-1">
                    ...
                    <div class="flex justify-between text-[10px] font-bold uppercase tracking-wide">
                        <span class="${pAmarillo > 90 ? 'text-[#F3BA2F]' : (pAmarillo === 0 ? 'text-white-600' : 'text-white-500')} transition-colors">
                            ${pAmarillo === 0 ? 'Sin compras P2P' : `Recomprado: ${Math.round(pAmarillo)}%`}
                        </span>
                        <span class="text-white-600 arial">
                            Sobrante: ${fVES(bank.fiatBalance)}
                        </span>
                    </div>
                </div>
            </div>
